...
use crate::backend::object_storage::{ObjectStorage, ObjectStorageError, ObjectStorageState};
...
/// Error codes related to S3 storage backend.
pub type S3Error = ObjectStorageError;
